            ...
            <div class="tab-content">
              ...
              <div class="tab-pane container active" id="hospitals">
                ...
                <form action="file/hospitalLogin.php" method="post">
                  ...
                  <label class="text text-muted font-weight-bold" >Hospital Email</label>
                  ...
                  <input type="submit" name="hlogin" value="Login" class="btn btn-danger btn-block mb-4">
              ...
              <div class="tab-pane container fade" id="receivers">
                ...
                <form action="file/receiverLogin.php" method="post">
                  ...
                  <input type="submit" name="rlogin" value="Login" class="btn btn-danger btn-block mb-4">
